...
public class ControladorRecetas {
	...
	public String obtenerTodasLasRecetas(Model modelo) {
		modelo.addAttribute("listaRecetas" ,recetasConIngredientes.keySet());
		return "recetas.jsp";
	}
	...
	public String obtenerRecetaPorNombre(@PathVariable("nombre") String nombre, Model modelo) {
		if (recetasConIngredientes.containsKey(nombre)){
			...
			modelo.addAttribute("receta", recetasConIngredientes.get(nombre));
		} else {
			String str = "La receta no se encuentra en nuestra lista.";
